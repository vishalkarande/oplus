...
if(isset($_POST['name'])) {
      ...
      if(empty($dummy)) {
          ...
          $data['is_verified'] = 0;
          $to = $data['email'];
          $subject = 'Welcome to Oplus. You have successfully created your profile.';
          ...
          $template = str_replace('%link2text%', 'Oplus' , $template);
        ...
        <div class="login">
          <div class="login-form-container">
            ...
            <div class="register-form">
              ...
              <input type="text" name="pincode" id="pincode" class="input-full" placeholder="Pincode">
