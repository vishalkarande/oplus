...
?>
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Clients <button class="btn btn-primary" data-toggle="modal" data-target="#myModal">Add Client</button></h1>
        </div>
        <div class="col-sm-6">
          ...
          <div class="card-body">
            ...
            <table class="data-table table table-bordered table-striped table-bordered table-hover">
              ...
              <tbody>
                ...
                <?php } } else {
                  echo '<td colspan="4" class="text-center">You have not added any client</td>';
                } ?>
              </tbody>
            </table>
          </div>
