...
?>
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Manage Products <a href="add-product" class="btn btn-primary btn-sm">Add Product</a> <a href="export-data?allProducts=1" class="btn btn-secondary pull-right btn-sm">Export Products</a></h1>
        </div>
        <div class="col-sm-6">
