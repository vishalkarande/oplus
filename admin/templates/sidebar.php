...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="dashboard" class="brand-link">
    O <span class="brand-text font-weight-light">Plus</span>
  </a>
      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          <a href="ad-sliders" class="nav-link <?php echo (isset($active_tab) && trim($active_tab) == 'ad sliders' ) ? 'active': ''; ?>">
		    ...
		    <li class="nav-item">
          <a href="date" class="nav-link <?php echo (isset($active_tab) && trim($active_tab) == 'date' ) ? 'active': ''; ?>">
            <i class="far fa-images nav-icon"></i>
            <p>
            	Date of Order
            </p>
		...
		<li class="nav-item">
          <a href="prime" class="nav-link <?php echo (isset($active_tab) && trim($active_tab) == 'prime' ) ? 'active': ''; ?>">
            <i class="far fa-address-card nav-icon"></i>
            <p>
              Prime
            </p>
