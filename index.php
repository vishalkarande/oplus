...
$slider2 = $QueryFire->getAllData('slider2',' is_show=1')[0];
...
<?php  if(!empty($categories)) { ?>
	<div class="product-area mt-40" style="margin-top:60px;padding-bottom:-20px"  >
		...
		<?php foreach($adSliders as $slider) { ?>
			<div class="single-slider discount-overlay"  >
			  <div class="testimonial-2-img">
				  ...
				  <p class="mt-30 mb-20 text-center"><strong>YOUR NEXT DILEVERY DATE IS:</strong></p>
                                    <p class="text-center "><strong><?php echo $slider2['text']?></strong></p>
                                </div>
			</div>
		<?php } ?>
	</div> 
							...
							<div class="product-wrapper mb-25">
								<div class="product-img">
									<a href="<?= base_url.'category/'.$cat['slug']?>">
										<img loading="lazy" src="<?= base_url.'images/categories/'.$cat['image_name']?>" alt="product_image">
									</a>
								</div>
...
<div class="banner-area mt-40">
    <div class="container">
		...
		<?php foreach($adSliders as $slider) { ?>
			<div class="single-slider discount-overlay" >
			    <img loading="lazy" src="<?= base_url.'images/sliders/'.$slider['image_name'] ?>" alt="Slider Image" style="height:300px;width:100%">
			</div>
		<?php } ?>
	</div> 
	</div>
			        ...
			        <div class="testimonial-4-img">
			            <div class="row">
                            <div class="col-md-6 col-sm-6 col-xs-6">
                                <div class="testimonial-2-img">
                                    <img loading="lazy" src="<?php echo base_url.'/images/testimonials/'.$testimonial['image_name']?>" alt="<?php echo $testimonial['name']?>" class="img-responsive img-thumbnail" />
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6">
                              <p class="testimonial-content text-justify">
                                <?= makeShortString($testimonial['opinion'],415) ?>
                              </p>
                            </div>
                        </div>
			        </div>
  ...
  <div class="container">
    ...
    <div class="brand-logo-active owl-carousel owl-loaded owl-drag">
        <?php foreach($clients as $client) { ?>
			<div class="item" >
                <img loading="lazy" src="<?php echo base_url.'/images/clients/'.$client['image_name']?>" alt="<?php echo $client['name']?>" class="img-responsive img-thumbnail" />
			</div>
		<?php } ?>
	</div>
  </div>
